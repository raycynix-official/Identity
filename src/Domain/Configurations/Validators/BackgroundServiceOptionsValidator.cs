...
/// </summary>
public sealed class BackgroundServiceOptionsValidator : IConfigurationValidator<BackgroundServiceOptions>
{
    /// <inheritdoc />
    public ConfigurationValidationResult Validate(BackgroundServiceOptions options)
    {
        try
        {
            options.Validate();
