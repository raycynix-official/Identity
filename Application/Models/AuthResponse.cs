...
/// <param name="EmailConfirmationToken">The email confirmation token generated by ASP.NET Core Identity.</param>
public record RegisterResponse(string Email, string EmailConfirmationToken);
...
/// <param name="Email">The registered user's email address.</param>
/// <param name="EmailConfirmationToken">The email confirmation token generated by ASP.NET Core Identity.</param>
public record RegisterResult(string Email, string EmailConfirmationToken);
